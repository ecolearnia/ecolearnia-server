...
internals.CourseManager.prototype.add = function(course, options)
{
    var self = this;
...
internals.CourseManager.prototype.find = function(criteria, options)
{
    return this.courseProvider.find(criteria, options)
};

/**
 * @param {Map.<String, Object>} criteria -  A map of criteria
 */
internals.CourseManager.prototype.query = function(criteria, options)
{
    return this.courseProvider.query(criteria, options)
};

internals.CourseManager.prototype.update = function(criteria, options)
{
    return this.courseProvider.update(criteria, options)
};

internals.CourseManager.prototype.remove = function(criteria, options)
{
    // Remove in the parent's
    return this.courseProvider.remove(criteria, options)
};
