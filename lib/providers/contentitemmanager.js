 ...
 *
 * @fileoverview
 *  This file includes definition of ContentItemManager class.
 *
...
internals.ContentItemManager.prototype.findByPK = function(pk, options)
{
    ...
    */
    ...
    var criteria = QueryHelper.createComparisonOp('=', this.contentItemProvider.primaryKey_, pk);
...
internals.ContentItemManager.prototype.count = function(criteria)
{
    return this.contentItemProvider.count(criteria);
};
