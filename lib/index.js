...
exports.register = function(plugin, options, next) {
    ...
    contentNodeResource.registerCustomRoute(plugin, moveNodeRoute);
    ...
    // Register routes for this resource
    contentNodeItemResource.registerRoutes(plugin);
    ...
    contentItemResource.registerCustomRoute(plugin, moveItemRoute);
