...
var QueryHelper = require('../../../lib/providers/queryhelper').QueryHelper;
...
describe('QueryParser', function () {
	...
	describe('parsing', function () {	
		...
		it('should parse', function () {
			...
			var ast = queryHelper.parse('c=3 OR (d=4 OR f="a" OR g=4 OR h=5 AND (i=0 OR j IN (9,10) OR k BETWEEN 10 AND 20) )');
			//var ast = queryHelper.parse('c=3 OR d=4 OR f="a" OR g=4');
	...
	describe('CriteriaTranslatorMongo', function () {
		...
		it.only('should generate mongo criteria', function () {
			var queryHelper = new QueryHelper();
